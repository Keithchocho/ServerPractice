...
// 서블릿 생성을 위해 HttpServlet 을 상속 받아야한다.
public class HelloServlet extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, // 요청 정보
		...
		// 출력 : 응답 객체로부터 PrintWriter 를 받아와서 내용을 출력
	...
	protected void doPost(HttpServletRequest req,
		...
		// 파라미터를 받아올 때 파리미터의 적절한 인코딩 정보를 전달
